...
<?php include '../layouts/feature.php';
    feature_txt('L\'éducation en Russie');
?>
    ...
    <div class="section sup-study">
        <div class="container">
            <div class="row">
                <hr class="section-title-line">
                <h2 class="section-title">ENSEIGNEMENT SUPERIEUR RUSSE</h2>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <p>Il existe trois types principaux d’établissements d’enseignement supérieur en Russie. Ce sont des universités, académies et instituts.</p>
                    <ol>
                        <li>Les universités offrent un large éventail de programmes sur le plus haut niveau d’éducation.</li>
                        <li>Les académies dispensent un enseignement supérieur à tous les niveaux et effectuent un grand nombre de travaux de recherche, généralement spécialisés dans une branche comme la science, l’art ou l’architecture.</li>
                        <li>Les instituts sont des entités indépendantes d'universités ou d'académies offrant des programmes de formation professionnelle.</li>
                    </ol>
                    <p>La Russie compte plus de diplômés universitaires que tout autre pays d'Europe. La Russie a toujours accordé beaucoup d’importance à la science et à la technologie dans l’éducation, et la plupart des institutions publiques sont spécialisées dans ce domaine. C’est également là que l’enseignement supérieur russe a la meilleure réputation.</p>
                </div>
            </div>            
        </div>
    </div>
    ...
    <div class="section sup-study">
        <div class="container">
            <div class="row">
                <hr class="section-title-line">
                <h2 class="section-title">Système d’éducation en Russie :</h2>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <p>L’enseignement supérieur en Russie dure normalement entre quatre et six ans. Les quatre premières années d'études universitaires à plein temps mènent à un baccalauréat. Le baccalauréat est décerné dans tous les domaines sauf la médecine, où la première étape dure six ans. 
                    Une fois que les étudiants ont obtenu leur baccalauréat, ils sont éligibles pour un programme de diplôme de spécialiste et de maîtrise. Le master est délivré après deux années d'études, dont l'une est une année de recherche incluant la pratique, la préparation et la défense d'une thèse. 
                    Des diplômes de licence et de maîtrise ont été introduits pour conformer le système russe au processus de Bologne.</p>
                </div>
            </div>            
        </div>
    </div>
    ...
    <div class="section sup-study">
        <div class="container">
            <div class="row">
                <hr class="section-title-line">
                <h2 class="section-title">MBBS EN RUSSIE</h2>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <p>Depuis des décennies, des milliers d'étudiants quittent leur pays d'origine à la recherche d'une bonne éducation. Il est essentiel pour eux de trouver un bon pays où ils peuvent trouver une université réputée et les cours qu’ils souhaitent suivre. Quand vient la question «Où aller étudier la médecine?», La Russie est la solution pour tous les étudiants prometteurs qui souhaitent poursuivre leur carrière dans le domaine de la médecine avec un coût minimal d'éducation.</p>
