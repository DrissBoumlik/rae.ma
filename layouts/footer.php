    ...
    <div class="section footer" <?php echo ($lang == 'ar') ? 'dir="rtl"' : '' ?> >
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 infos">
                    ...
                    <div class="row">
                        <div class="">
                            ...
                            <label><i class="fas fa-at"></i><span><?php echo (($lang == 'ar') ? '7 شارع بنزرت ، الطابق الثالث ، حسان الرباط ، المغرب' : (($lang == 'en') ? '7 BENZERTE STREET, 3RD FLOOR, HASSAN RABAT, MOROCCO' : '7 RUE BENZERTE, 3 EME ETAGE, HASSAN RABAT, MAROC')); ?></span></label>
                            <hr/>
