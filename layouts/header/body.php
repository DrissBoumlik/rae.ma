                ...
                <div class="container">
                    ...
                    <!-- . // class="navbar-collapse collapse"> -->
                        <ul id="menu-main-menu" class="nav navbar-nav">
                            <li class="' . ($active_page == '1' ? 'active' : '') .'"><a href="/?lang='. $lang .'">'. (($lang == 'ar') ? 'إستقبال' : (($lang == 'en') ? 'Home' : 'Accueil')) .'</a></li><li class="' . ($active_page == '2' ? 'active' : '') .'"><a class="has-submenu" href="#" >'.(($lang == 'ar') ? 'في ما يخصنا' : (($lang == 'en') ? 'About us' : 'A propos de nous')).'</a>
                                <ul class="submenu">
                            ...
                            </li><li class="' . ($active_page == '3' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'أوكرانيا' : (($lang == 'en') ? 'Ukraine' : 'Ukraine')).'</a>
                                <ul class="submenu">
                            ...
                            </li><li class="' . ($active_page == '4' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'روسيا' : (($lang == 'en') ? 'Russia' : 'Russie')).'</a>
                                <ul class="submenu">
                            ...
                            </li><li class="' . ($active_page == '5' ? 'active' : '') .'"><a href="/pages/register.php?lang='. $lang .'">'.(($lang == 'ar') ? 'كيفية التسجيل' : (($lang == 'en') ? 'How to register' : 'Comment s\'inscrire')).'</a></li><li class="' . ($active_page == '6' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'التأشيرة والوصول' : (($lang == 'en') ? 'Visa and Arrival' : 'Visa et Arrivée')).'</a>
                                <ul class="submenu">
