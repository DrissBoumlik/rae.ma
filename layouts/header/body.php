                ...
                <div class="container">
                    ...
                    <!-- . // class="navbar-collapse collapse"> -->
                        <ul id="menu-main-menu" class="nav navbar-nav" '. (($lang == 'ar') ? 'dir="rtl"' : '') .'>
                            ...
                            <li class="' . ($active_page == '3' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'أوكرانيا' : (($lang == 'en') ? 'Ukraine' : 'Ukraine')).'</a>
                                <ul class="submenu">
                            ...
                            <li class="' . ($active_page == '4' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'روسيا' : (($lang == 'en') ? 'Russia' : 'Russie')).'</a>
                                <ul class="submenu">
                            ...
                            <li class="' . ($active_page == '5' ? 'active' : '') .'"><a href="/pages/register.php?lang='. $lang .'">'.(($lang == 'ar') ? 'كيفية التسجيل' : (($lang == 'en') ? 'How to register' : 'Comment s\'inscrire')).'</a></li>
                            <li class="' . ($active_page == '6' ? 'active' : '') .'"><a class="has-submenu" href="#">'.(($lang == 'ar') ? 'التأشيرة والوصول' : (($lang == 'en') ? 'Visa and Arrival' : 'Visa et Arrivée')).'</a>
                                <ul class="submenu">
                            ...
                            <li class="' . ($active_page == '7' ? 'active' : '') .'"><a title="Resume" href="/pages/contact.php?lang='. $lang .'">'.(($lang == 'ar') ? 'اتصال' : (($lang == 'en') ? 'Contact' : 'Contact')).'</a></li>
                        </ul>                        
                    </div><!--/.navbar-collapse -->
                </div>
            </nav>
