...
<?php include $path.'/layouts/feature.php';
    feature_txt('Pourquoi Ukraine ?', "ukraine");
?>
    ...
    <div class="section why">
        <div class="">
            <div class="row">
                ...
                <h2 class="section-title">Pourquoi Ukraine ?</h2>
            </div>
            <div class="row">
                <p>Le nombre d'étudiants étrangers souhaitant poursuivre des études supérieures en Ukraine augmente chaque jour. Cela n’est pas surprenant, car l’Ukraine offre d’excellentes possibilités de recevoir un diplôme universitaire dans la spécialité souhaitée</p>
            </div>
            <div class="row">
                <hr class="section-title-line">
                <h2 class="section-title">LISTE DES RAISONS POUR LESQUELLES CHOISIR L'UKRAINE </h2>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <ul class="reason-items list-group">
                        <li class="list-group-item">Education de qualité pour tous les étudiants internationaux
                        ...
                        <li class="list-group-item">Cours reconnus dans le monde entier (Europe, Royaume-Uni, États-Unis, Asie, Afrique, OMS, UNESCO, CONSEIL EUROPÉEN, etc.)
                        ...
                        <li class="list-group-item">EXAMENS PAS D'ENTRÉE, SEULEMENT CERTIFICAT D'ÉCOLE SECONDAIRE pour les programmes de baccalauréat
                        ...
                        <li class="list-group-item">Les frais de scolarité sont payés à l'arrivée
                        ...
                        <li class="list-group-item">Rentable (éducation européenne la moins chère)
                        ...
                        <li class="list-group-item">European Life Standard
                        ...
                        <li class="list-group-item">Attention personnelle à chaque élève, assiduité à 100%
                        ...
                        <li class="list-group-item">De meilleures perspectives d'emploi
                            L'Ukraine est un bon endroit pour commencer sa carrière.
                        </li>
                        <li class="list-group-item">Climat modéré toute l'année
                            Oubliez le chaud étonnant ou le froid à vie. Toutes les saisons de l'année sont belles en Ukraine.
                        </li>
                        <li class="list-group-item">Enrichissement de l'expérience grâce aux professeurs invités des États-Unis, du Canada, du Royaume-Uni, de l'Inde, etc.
