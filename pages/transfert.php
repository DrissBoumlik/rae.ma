...
<div class="section transfer">
	<div class="">
		...
		<div class="row">
			...
			<p><?php echo (($lang == 'ar') ? "<span class='btn btn-danger'>هام!</span> بسبب تشريعات أوكرانيا ، يجب إعادة الطلاب الأجانب الذين يصلون دون إبلاغ ممثليهم عن وصولهم إلى بلادهم دون سبب !!!" : (($lang == 'en') ? "<span class='btn btn-danger'>IMPORTANT!</span> Due to the legislation of Ukraine, foreign students arriving without informing their representatives of their arrival should be returned to their country without reason !!!" : "<span class='btn btn-danger'>IMPORTANT!</span> En raison de la législation de l'Ukraine, les étudiants étrangers qui arrivent sans informer leurs représentants de leur arrivée devraient être renvoyés dans leur pays sans motif !!!")); ?></p>
			...
			<p><?php echo (($lang == 'ar') ? "<span class='btn btn-danger'>هام!</span> يجب على الطلاب المسافرين إلى أوكرانيا ارتداء رسالة الدعوة الأصلية في الأمتعة المحمولة ، حيث ستحتاج إليها أثناء تفويض خدمة الترحيل!" : (($lang == 'en') ? "<span class='btn btn-danger'>IMPORTANT!</span> Students traveling to Ukraine must wear the original letter of invitation in the carry-on baggage, as you will need it during the authorization of the migration service!" : "<span class='btn btn-danger'>IMPORTANT!</span> Les étudiants qui voyagent en Ukraine doivent porter la lettre d'invitation originale dans le bagage à main, car vous en aurez besoin pendant l'autorisation du service de migration!")); ?></p>
