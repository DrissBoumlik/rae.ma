...
<div class="section register">
    <div class="">
        ...
        <hr>
        <p><?php echo (($lang == 'ar') ? "<span class='alert alert-danger italic'>انتباه :</span>  يعتمد التسجيل على توافر الأماكن المحجوزة من قبل جامعات دولة أوكرانيا / روسيا للطلاب القادمين من المغرب. من المستحسن عدم التأخير في إيداع الملف!" : (($lang == 'en') ? "<span class='alert alert-danger italic'>Attention :</span> Registration is based on the availability of places reserved by the universities of the State of Ukraine / Russia for students coming from Morocco. It is recommended not to delay with the filing of the file!" : "<span class='alert alert-danger italic'>Attention : </span> Les inscriptions se font selon la disponibilité des places réservées par les universités de l'état d'Ukraine /Russie pour les étudiants venant du Maroc. Il est recommandé de ne pas tarder avec le dépôt du dossier !!!")); ?></p>
    </div>
</div>
