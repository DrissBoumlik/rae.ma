            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="service-items list-group">
                        ...
                        <li class="list-group-item"><?php echo (($lang == 'ar') ? 'التواصل مع أولياء الأمور ومعلوماتهم حسب الطلب ؛' : (($lang == 'en') ? 'Communication with parents and their information on demand;' : 'Communication avec des parents et leur information à la demande;')); ?></li>
