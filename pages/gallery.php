                    ...
                    <?php for($i=1;$i<=9;$i++){ ?>
                        <div class="col-sm-6 col-md-4">
                            <a class="lightbox" href="images/gallery/1 (<?php echo $i; ?>).jpg">
                                <img src="https://projects.drissboumlik.com/rae.ma/images/gallery/1 (<?php echo $i; ?>).jpg" alt="">
                            </a>
                        </div>
                    <?php } ?>
                    </div>
                    ...
                    <?php for($i=1;$i<=17;$i++){ ?>
                        <div class="col-sm-6 col-md-4">
                            <a class="lightbox" href="images/Hebergement/1 (<?php echo $i; ?>).jpg">
                                <img src="https://projects.drissboumlik.com/rae.ma/images/Hebergement/1 (<?php echo $i; ?>).jpg" alt="">
                            </a>
                        </div>
                    <?php } ?>
                    </div>
