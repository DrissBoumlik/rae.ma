            ...
            <div class="">
                ...
                <div class="row">
                    ...
                    <ol class="keep-list-style list-group">
                        ...
                        <li class="list-group-item"><?php echo (($lang == 'ar') ? "صورتا هوية بحجم 35 × 45 ملم على خلفية بيضاء ، يمثل الوجه 70 إلى 80٪ من الصورة." : (($lang == 'en') ? "Two 35 x 45 mm identity photos on a white background, the face representing 70 to 80% of the photo." : "Deux photos d’identité couleur 35 x 45 mm, sur fond blanc, le visage représentant 70 à 80% de la photo.")); ?></li>
        ...
        <div class="section">
            <div class="">
                ...
                <div class="row">
                    ...
                    <div class="note">
                        <span class="alert alert-danger"><?php echo (($lang == 'ar') ? "مهم جدا" : (($lang == 'en') ? "Very important" : "TRES IMPORTANT")); ?> :</span>
