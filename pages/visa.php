        ...
        <div class="section">
            <div class="">
                ...
                <div class="row">
                    ...
                    <ul class="keep-list-style list-group">
                        ...
                        <li class="list-group-item"><?php echo (($lang == 'ar') ? "جواز سفر بالإضافة إلى صورة من الصفحات الرئيسية لجواز السفر (صفحات مع صورة ، تاريخ صلاحية جواز السفر ، تأشيرات مختلفة). يجب أن يستوفي جواز السفر المتطلبات التالية:" : (($lang == 'en') ? "Passport plus photocopy of the main pages of the passport (pages with photo, date of validity of the passport, various visas). The passport must meet the following requirements:" : "Passeport plus photocopie des pages principales du passeport (pages avec photo, date de validité du passeport, divers visas). Le passeport doit répondre aux exigences suivantes:")); ?>
                            <ul class="list-group">
                                <li class="list-group-item"><?php echo (($lang == 'ar') ? "يجب أن تكون مدة صلاحيتها 3 أشهر على الأقل بعد تاريخ انتهاء التأشيرة المطلوبة ؛" : (($lang == 'en') ? "its period of validity must be at least 3 months beyond the date of expiry of the requested visa;" : "sa durée de validité doit dépasser de 3 mois au moins la date de l'expiration du visa demandé;")); ?></li>
                                <li class="list-group-item"><?php echo (($lang == 'ar') ? "يجب أن يتم إصداره في غضون السنوات العشر الماضية ؛" : (($lang == 'en') ? "it must be issued within the last 10 years;" : "il doit être délivré au cours des 10 dernières années;")); ?></li>
                                <li class="list-group-item"><?php echo (($lang == 'ar') ? "يجب أن يكون حتما 2 صفحات حرة." : (($lang == 'en') ? "it must imperatively have 2 free pages." : "il doit être impérativement comporter 2 pages libres.")); ?></li>
                            </ul>
                        </li>
