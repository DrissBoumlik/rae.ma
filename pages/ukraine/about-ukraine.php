<?php $path = $_SERVER['DOCUMENT_ROOT'];
    ...
    title_page('à propos d\'Ukraine',3)
?>
    ...
    <div class="">
        <div class="section">
            <div class="">
                <div class="row">
                    ...
                    <h2 class="capitalize section-title">à propos d'Ukraine</h2>
                </div>
                <div class="row">
                    <p>L'Ukraine est votre meilleure option si vous recherchez vos prochaines étapes en matière d'éducation pour une université anglophone en Europe.</p>
                </div>
            </div>
        </div>
        <div class="section">
            <div class="">
                ...
                <div class="row">
                    <p>La population est de 44 millions. 
                    Territoire 603 700 km 2 La
                    capitale Kyiv (Kiev)
                    La langue officielle est l'ukrainien, mais le russe et l'anglais sont largement parlés.</p>
                </div>
            </div>
        </div>
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="capitalize section-title">CLIMAT</h2>
                    <h3>Profitez de la beauté des 4 saisons!</h3>
                </div>
                <div class="row">
                    <p>En séjournant en Ukraine, vous aurez une occasion unique de profiter de la beauté des 4 saisons, avec toutes leurs caractéristiques exceptionnelles.
        ...
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="capitalize section-title">La vie de l'étudiant</h2>
                    <h3>La vie étudiante en Ukraine est visiblement moins chère que celle d’autres pays européens!</h3>
                </div>
                <div class="row">
                    <p>C'est un endroit où étudier va au-delà des salles de classe. Profitez de votre vie multiculturelle et obtenez de nouvelles expériences chaque jour! Apprenez des meilleurs spécialistes et prospérez en tant que professionnel mondialement reconnu. L'Ukraine vous donne cette chance.
