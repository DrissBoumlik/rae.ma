...
<?php 
    ...
    title_page("Académie Nationale Des Technologies Alimentaires D’Odessa")
?>
...
<div class="post">
    <div class="post-header"><div class="col-sm-12 col-md-12">
        <h2 class="">Académie Nationale Des Technologies Alimentaires D’Odessa</h2>
    </div></div>
    <div class="post-img"><img src="/images/universities/ukraine/21.png" alt=""></div>
    <div class="post-txt">
