<?php 
    ...
    title_page("Académie d'état de génie civil et d'architecture d’Odessa")
?>
...
<div class="post">
    <div class="post-header"><div class="col-sm-12 col-md-12">
        <h2 class="">Académie d'état de génie civil et d'architecture d’Odessa</h2>
    </div></div>
    <div class="post-img"><img src="/images/universities/ukraine/25.png" alt=""></div>
    <div class="post-txt">
        <p> Académie d’État de génie civil et d’architecture d’Odessa est le successeur des glorieuses traditions de l’École des ouvriers du bâtiment d’Odessa du département d’Odessa (Novorossiysk) de la Société technique russe impériale à partir de 1891. </p>
