    ...
    <div class="">
        <div class="section">
            <div class="">
                <div class="row">
                    ...
                    <h2 class="uppercase section-title"><?php echo (($lang == 'ar') ? "التعليم في روسيا" : (($lang == 'en') ? "Education in Russia" : "L'éducation en Russie")); ?></h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>Higher education in Russia crosses new frontiers by becoming a stronger competitor of European universities.</p>" : "<p>La Russie est sans aucun doute une destination de choix pour les étudiants du monde entier. Avec son vaste territoire, le pays compte des centaines d'universités dans les grandes villes. Pendant leurs études en Russie, les étrangers ont l’occasion formidable d’acquérir des connaissances et des compétences excellentes dans le domaine de l’éducation, ainsi que par l’apprentissage de la langue russe, de ressentir l’atmosphère authentique de l’hospitalité russe, d’observer le patrimoine culturel et beauté authentique de la nature russe - merveilleux paysages de pays, magnifiques montagnes et paysages lacustres et marins. </p>
        ...
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="uppercase section-title"><?php echo (($lang == 'ar') ? "التعليم العالي الروسي" : (($lang == 'en') ? "RUSSIAN HIGHER EDUCATION" : "ENSEIGNEMENT SUPERIEUR RUSSE")); ?></h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="uppercase section-title"><?php echo (($lang == 'ar') ? "نظام التعليم في روسيا:" : (($lang == 'en') ? "Education system in Russia:" : "Système d’éducation en Russie :")); ?></h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <p><?php echo (($lang == 'ar') ? "عادة ما يستمر التعليم العالي في روسيا ما بين أربع إلى ست سنوات. تؤدي السنوات الأربع الأولى للدراسة الجامعية بدوام كامل إلى الحصول على درجة البكالوريوس. تُمنح شهادة البكالوريا في جميع المجالات باستثناء الطب ، حيث تستغرق المرحلة الأولى ست سنوات. بمجرد تخرج الطلاب ، يكونون مؤهلين للحصول على برنامج درجة الماجستير المتخصص. يتم منح الماجستير بعد عامين من الدراسة ، واحدة منها هي سنة من البحوث بما في ذلك الممارسة والإعداد والدفاع عن الأطروحة. تم تقديم شهادات البكالوريوس والماجستير لإدخال النظام الروسي في عملية بولونيا." : (($lang == 'en') ? "Higher education in Russia normally lasts between four and six years. The first four years of full-time university studies lead to a bachelor's degree. The baccalaureate is awarded in all fields except medicine, where the first stage lasts six years. Once students have graduated, they are eligible for a specialist and master's degree program. The master is awarded after two years of study, one of which is a year of research including practice, preparation and defense of a thesis. Bachelor's and Master's degrees have been introduced to bring the Russian system into the Bologna Process." : "L’enseignement supérieur en Russie dure normalement entre quatre et six ans. Les quatre premières années d'études universitaires à plein temps mènent à une licence. La licence est décerné dans tous les domaines sauf la médecine, où la première étape dure six ans. 
        ...
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="uppercase section-title"><?php echo (($lang == 'ar') ? "الطلاب الدوليين في روسيا" : (($lang == 'en') ? "INTERNATIONAL STUDENTS IN RUSSIA" : "ÉTUDIANTS INTERNATIONAUX EN RUSSIE")); ?></h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
        ...
        <div class="section">
            <div class="">
                <div class="row">
                    <hr class="section-title-line">
                    <h2 class="uppercase section-title"><?php echo (($lang == 'ar') ? "MBBS في روسيا" : (($lang == 'en') ? "MBBS IN RUSSIA" : "MBBS EN RUSSIE")); ?></h2>
                </div>
                <div class="row">
                    <div class="col-md-12">
