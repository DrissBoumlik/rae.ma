        ...
        <div class="">
            ...
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">INFORMATIONS GÉNÉRALES</h2>
                    </div>
                    <div class="row">
                        <p>La Russie ou  la Fédération de Russie  est un pays avec une grande histoire, la maison de scientifiques célèbres et une terre de beauté naturelle.  
                        Capitale : Moscou
            ...
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">climat et nature</h2>
                        <h3>La beauté des paysages naturels de la Russie va vous couper le souffle!</h3>
                    </div>
                    <div class="row">
                        <p>Les quatre saisons - été, automne, hiver et printemps - se distinguent facilement. Chaque saison dure environ trois mois, ce qui rend le climat agréable. Alors que la Russie s’étend sur une vaste région du sud au nord et d’ouest en est, le climat varie selon les régions du pays.
            ...
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">POPULATION ET SOCIETE</h2>
                        <h3>Passez un moment incroyable autour d'un peuple amical et chaleureux!</h3>
                    </div>
                    <div class="row">
                        <p>La Russie est le cinquième pays le plus peuplé au monde (148,8 millions d’habitants) après la Chine, l’Inde, les États-Unis et l’Indonésie. 
            ...
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">CULTURE ET ART</h2>
                        <h3>Vous serez certainement inspiré par le patrimoine culturel et l'art moderne!</h3>
                    </div>
                    <div class="row">
                        <p>La Russie compte plus de 50 000 bibliothèques publiques nationales qui possèdent plus d’un milliard de livres. Il existe environ 1500 musées (historiques, ethnographiques, mémoriaux, d’artisanat populaire, des beaux-arts et des arts appliqués, le théâtre, la musique, les sciences naturelles, la technologie et bien d’autres). Vingt musées ethnographiques à ciel ouvert présentent l'architecture populaire, les arts et la vie quotidienne.</p>
                    </div>
                </div>
            </div>
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">SCIENCE ET TECHNOLOGIES</h2>
                        <h3>Découvrez les recherches scientifiques et techniques les plus récentes et les célèbres inventions de scientifiques russes remarquables!</h3>
                    </div>
                    <div class="row">
                        <p>La Russie a été la première à développer et à explorer de nombreuses branches de la recherche scientifique et de ses réalisations: 
            ...
            <div class="section">
                <div class="">
                    <div class="row">
                        <hr class="section-title-line">
                        <h2 class="capitalize section-title">VIE ÉTUDIANTE</h2>
                        <h3>Devenez étudiant d'une prestigieuse université d'État et vivez une vie indépendante pleine de nouvelles impressions, d'émotions et d'amis!</h3>
                    </div>
                    <div class="row">
                        <p>La vie étudiante… il ne s'agit pas que d'étude. Vous visiterez des musées, des cinémas, des concerts intéressants, des spectacles et des performances. vous allez rencontrer de nouveaux amis de toutes les régions de notre globe. C'est une expérience amusante, enrichissante et excitante.
