...
?>
    ...
    <div class="section why">
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="reason-items list-group">
                        ...
                        <li class="list-group-item">Les certificats IELTS / TOEFL ou autres ne sont pas nécessaires;</li>
                        ...
                        <li class="list-group-item">Cours pratiques d'hôpital à partir de la 2<sup>ème</sup> année ;</li>
            ...
            <p>La Russie est un acteur économique et politique majeur dans le monde. C’est l’une des nombreuses raisons pour lesquelles la réputation des universités et des diplômes obtenus est reconnue dans le monde entier et montre au futur employeur que l’étudiant avait une solide formation de base et une connaissance du travail pratique.</p>
