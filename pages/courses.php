...
<div class="section courses diplomas">
    ...
    <p class="course-txt"><?php echo (($lang == 'ar') ? "يتوفر التعليم في الجامعات الأوكرانية و الروسية باللغتين الإنجليزية والروسية. إذا اخترت دورة في اللغة الروسية ، فستكون هناك حاجة إلى سنة تحضيرية لتدريس اللغة ، حيث يتعلمون الموضوعات المتعلقة بخيارهم في الدراسة. لذا ، بالنسبة لطلاب الطب ، يتعلمون علم الأحياء والكيمياء والفيزياء الحيوية وما إلى ذلك." : (($lang == 'en') ? "Education at Ukrainian and Russian universities is available in English and Russian. If you choose a course in Russian, a preparatory year of teaching the language will be necessary they learn the subjects related to their option of studies. So for medical students, they learn biology, chemistry, biophysics, and so on." : "L’Enseignement aux universités ukrainiennes et russes est disponible en anglais et en russe. Si vous choisissez une filière en russe, une année préparatoire d’enseignement de la langue sera nécessaire ils apprennent les matières relatives à leur option d’études. Ainsi pour les étudiants de médecine, ils apprennent la biologie, la chimie, biophysique, etc. ")); ?></p>
    <p class="course-txt"><?php echo (($lang == 'ar') ? "<span class='alert alert-danger'>NB :</span>  تقدم دورة اللغة الإنجليزية دورات إلزامية في اللغة الروسية وهي ضرورية للتواصل الجيد ، والمعيشة المريحة والحياة اليومية في جميع مراحل الدراسة بالإضافة إلى إتقان الموارد التعليمية." : (($lang == 'en') ? "<span class='alert alert-danger'>NB :</span> The English language course provides compulsory courses in the Russian language which is necessary for good communication, comfortable living and daily life throughout the course of study as well as for the mastery of educational resources." : "<span class='alert alert-danger'>NB :</span> La formation en anglais prévoit les cours obligatoires de la langue russe ce qui est nécessaire pour la bonne communication, pour le séjour confortable et pour la vie quotidienne pendant toute la durée des études aussi que pour la maitrise des ressources éducatives.")); ?></p>
</div>
